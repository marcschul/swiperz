export default function Header(props) {
  ...
  return (
    ...
    <h1 className="pb-0 text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 xl:text-7xl xl:pb-2">{message}</h1>
